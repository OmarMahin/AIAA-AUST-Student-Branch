	...
	return (
		<div>
			<Flex className={"flex flex-col items-center mb-6"}>
				<div className='w-[200px] h-[200px] rounded-full bg-[#D6DDE5] overflow-hidden relative'>
					<Image
				...
				<h3 className={` mt-7 font-poppins font-bold text-darknest_blue ${name.length > 25 ? 'text-[18px] py-[6px]' : 'text-[22px]'}  text-center`}>
					{name}
				</h3>
