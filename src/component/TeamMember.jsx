	...
	return (
		<div>
			<Flex className={`flex flex-col items-center mb-6 ${className} w-[300px]`}>
				...
				<h3
					className={` mt-7 font-poppins font-bold text-darknest_blue ${
						name.length > 25
							? "lg:text-[17px] text-[16px] py-[6px]"
							: "lg:text-[22px] text-[20px]"
					}  text-center`}
				>
					{name}
				</h3>
				...
				<h3 className='mt-3 font-poppins font-bold text-darker_blue text-xl text-center'>
					{deparment}
				</h3>
				<h3 className='font-poppins font-bold text-darker_blue text-xl text-center'>
					{deparment2}
				</h3>
			</Flex>
		</div>
