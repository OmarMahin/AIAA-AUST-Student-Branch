...
const BlogPostCard = () => {
	return (
		<Flex className={"flex flex-col w-[450px] relative after:absolute after:h-[3px] after:w-[30%] after:bg-light-blue after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:rounded-full hover:after:w-[60%] after:duration-300 group rounded-xl overflow-hidden shadow-around-small"}>
			<div className={"relative h-[270px] after:bg-black/5 after:absolute after:w-full after:h-full overflow-hidden"}>
				<Image
					src={"/images/blog/swashplate/cardBanner.png"}
					alt={"Banner"}
			...
			<div className={"pt-5 pb-10 px-4 border-[1px] border-gray-300 border-t-0 rounded-xl rounded-t-none"}>
                <Flex className={'mb-5 justify-between items-center text-[13px]'}>
                    ...
                    <span className="py-1 px-4 bg-darker_blue rounded-full font-poppins font-semibold text-white shadow-around">Latest</span>
                    <span className="py-1 px-4 bg-darker_blue rounded-full font-poppins font-semibold text-white shadow-around">Informational</span>
                    </Flex>
				...
				<p className={"font-poppins font-semibold text-[15px] text-font-color mt-4 h-[70px] truncate text-wrap"}>
