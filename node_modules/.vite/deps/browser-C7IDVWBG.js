...
var ieee754, import_node_buffer, UINT8, UINT16_LE, UINT16_BE, UINT32_LE, UINT32_BE, INT32_BE, UINT64_LE, StringType, AnsiStringType;
var init_lib = __esm({
  "node_modules/token-types/lib/index.js"() {
...
var import_node_buffer2, minimumBytes, FileTypeParser, supportedExtensions, supportedMimeTypes;
var init_core2 = __esm({
  "node_modules/file-type/core.js"() {
    import_node_buffer2 = __toESM(require_node_buffer(), 1);
    init_lib();
    init_core();
    init_util();
    init_supported();
    ...
    FileTypeParser = class {
      ...
      async toDetectionStream(readableStream, options = {}) {
        const { default: stream } = await import("./node_stream-JOPMXBAT.js");
          ...
          readableStream.once("readable", () => {
            (async () => {
              try {
                ...
                const chunk = readableStream.read(sampleSize) ?? readableStream.read() ?? import_node_buffer2.Buffer.alloc(0);
                try {
      ...
      async parse(tokenizer) {
        ...
        if (this.checkString("OggS")) {
          ...
          const type = import_node_buffer2.Buffer.alloc(8);
        ...
        if (this.checkString("%PDF")) {
          try {
            ...
            const buffer = import_node_buffer2.Buffer.alloc(Math.min(maxBufferSize2, tokenizer.fileInfo.size));
...
var import_readable_web_to_node_stream;
var init_browser = __esm({
  "node_modules/file-type/browser.js"() {
    import_readable_web_to_node_stream = __toESM(require_lib());
    init_core2();
    init_core2();
  }
});
...
export {
  fileTypeFromBuffer,
  fileTypeFromStream2 as fileTypeFromStream,
...
*/
//# sourceMappingURL=browser-C7IDVWBG.js.map
